...
words = { "goingon_phrase"  : ("происходит", "случилось", "было", "происходило", "обстановка", "обстановочка", "ситуация"),
          ...
          "you_word"        : ("ассистент", "илья", "илюша", "илюш", "dacia", name[lang_code].lower(), "дасся", "ассистент", "асистент", "даси", "дася", "дасти", "раб", "ассистентраб", "rub", "досюда", "дося", "досю"),
          "youknow_word"    : ("знаешь", "знаете", "слышал", "слышали", "слыхал", "слыхали"),
          "welldone_phrases": ("отлично", "спасибо", "спасиба", "круто", "намана", "остроумно", "прекрасно", "смешно", "нормально", "интересно", "смишно", "смищно", "молодец", "умница", "зашибись", "замечательно", "забавно", "весело", "класс", "классно", "крутой", "классный", "крутяк", "красавчик"),
          ...
          "turn_on"         : ("включи", "включить"),
          "turn_off"        : ("выключи", "выключить"), }
