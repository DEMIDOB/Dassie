...
words = { "goingon_phrase"  : ("occurs", "happened", "was", "happened", "atmosphere", "обстановочка", "situation"),
          ...
          "how_word"        : ("how", "howww"),
          "still_word"      : ("before", "still", "good", "lucky", "nice"),
          ...
          "welldone_phrases": ("amazing", "thanks", "wow", "lol" "cool", "okeysi", "wittily", "funny", "normal", "interesting", "fuuunny", "смищно", "attaboy", "brains", "great", "замечательно", "comic", "hilarious", "great", "cool"),
